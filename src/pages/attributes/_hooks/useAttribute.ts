...
export const useAttribute = (
  ...
  const [valueToDelete, setValueToDelete] =
    useState<AttributeValuePayload | null>(null);
  ...
  const { mutate: performDeleteAttribute, isPending: isDeletingAttribute } =
    useMutation({
      mutationFn: (attributeId: string | number) =>
  ...
  const { mutate: performDeleteValue, isPending: isDeletingValue } =
    useMutation({
  ...
  const { mutateAsync: performAddAttribute, isPending: isAddingAttribute } =
    useMutation({
  ...
  const { mutateAsync: performUpdateAttribute, isPending: isUpdatingAttribute } =
    useMutation({
      mutationFn: ({
        id,
        formData,
  ...
  const { mutateAsync: performAddValue, isPending: isAddingValue } =
    useMutation({
  ...
  const { mutateAsync: performUpdateValue, isPending: isUpdatingValue } =
    useMutation({
      mutationFn: ({
        id,
        formData,
